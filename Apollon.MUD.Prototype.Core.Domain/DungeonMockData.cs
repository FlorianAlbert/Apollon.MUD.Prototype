...
namespace Apollon.MUD.Prototype.Core.Domain
{
    public static class DungeonMockData
    {
        ...
        static DungeonMockData()
        {
            ...
            IRace Orks = new RaceSkeleton("Ork", "Okrs sind schlimme Wesen.", 50, 20, 10);
            ...
            Takeable Flasche = new Takeable("Flasche", "Diese Flasche ist leer.", 2);
            ...
            IRoom Room2 = new RoomSkeleton(1, "Dies ist der zweite Raum des Dungeons.")
            {
                ...
                DirectionsToNeigbors = new List<Interfaces.Direction.EDirections>
                    {EDirections.NORTH, EDirections.SOUTH, EDirections.EAST, EDirections.WEST}
            };
            ...
            Neighborship Neighborship1 = new Neighborship(0, EDirections.NORTH, 1);
            Neighborship Neighborship2 = new Neighborship(1, EDirections.NORTH, 2);
            Neighborship Neighborship3 = new Neighborship(1, EDirections.EAST, 3);
            Neighborship Neighborship4 = new Neighborship(1, EDirections.WEST, 4);
